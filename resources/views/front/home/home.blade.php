...
@section('content')
                            ...
                            <div class="row justify-content-center justify-content-lg-start">
                                <div class="col-md-7 ">
                                    <div class="detail-box">
                                        ...
                                        <p class="slider-info">
                                            Trying to be more unique and elevate your style? When you don't know where to
                                            begin, the task of revamping your entire wardrobe can appear daunting and often
                                            overwhelming. What is our recommendation? We provide Asian dress trends as well
                                            as the best Asian clothing. Asian fashion styles spreading into mainstream media
                                            around the world. Taking into consideration the vast styles offered in Asian
                                            fashion, Asian clothing to shop at (Name)
                                        </p>
                            ...
                            <div class="row justify-content-center justify-content-lg-start">
                                <div class="col-md-7">
                                    <div class="detail-box">
                                        ...
                                        <p class="slider-info">
                                            What comes to mind when you think of traditional Asian clothes? It reminds us of
                                            excellence, rich embroidery and zardozi work, and extravagant silhouettes. This
                                            traditional look has evolved into a more contemporary style over time. (Name)
                                            creates exquisite fusions of traditional red bridal gowns and modern
                                            silhouettes. With intricate zardozi and stonework, layered tops, and flowy and
                                            voluminous skirts, our Asian wear captures the Mughal vibe. Long dromatic
                                            trails, 30 flowers, beaded tassels, scalloped edges, and flared sleeves add a
                                            modern touch.
                                        </p>
                    ...
                    <div class="box ">
                        ...
                        <div class="detail-box">
                            ...
                            <p>
                                ...
                                Get On Time Delivary To Be Stylish.
                            </p>
                        </div>
                    </div>
                </div>
                    ...
                    <div class="box ">
                        ...
                        <div class="detail-box">
                            ...
                            <p>
                                ...
                                Our Delivary man will delivar on your place.
                            </p>
                        </div>
                    </div>
                </div>
                <div class="col-md-4">
                    <div class="box ">
                        ...
                        <div class="detail-box">
                            ...
                            <p>
                                We Provide Best quality clothing materials. Be confident with our products.
                            </p>
                        </div>
                    </div>
                </div>
    ...
    <!-- arrival section -->
    <section class="arrival_section d-none ">
        <div class="container">
            <div class="box">
                    ...
                    <div class="col-sm-6 col-md-4 col-lg-4">
                        <div class="box">
                            ...
                            <div class="detail-box">
                                ...
                                <h6>
                                    ${{ $service->crafting_price + $service->crafting_price * 0.05 }}
                                </h6>
                            </div>
                        </div>
                    </div>
                ...
                <div class="row ">
                    <div class="col-md-12">
                        <div class="subscribe_form ">
                            ...
                            <form action="{{ route('place-contact-request') }}" method="POST" id="contact-form">
                                @csrf

                                <div class="row w-100 justify-content-center">
                                    <div class="col-md-4">
                                        <input type="text" placeholder="Your Name" name="name">
                                        <input type="text" placeholder="Email/Number" name="contact">
                                    </div>
                            ...
                            <div class="img_container">
                                <div class="img-box">
                                    <div class="img_box-inner">
                                        <img src="{{ asset('front/images/user.webp') }}" alt="">
                                    </div>
                                </div>
                            </div>
                            <div class="detail-box">
    ...
    @if (Session::get('success'))
        <div class="modal fade" id="modalsuccess" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel"
            ...
            <div class="modal-dialog modal-dialog-centered" role="document">
                <div class="modal-content">
                    <div class="modal-header">
                        <h5 class="modal-title" id="exampleModalLabel">Message Received</h5>
                        <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                            <span aria-hidden="true">&times;</span>
                        </button>
                    </div>
                    <div class="modal-body">
                       <p>Requested Successfully</p>
                    </div>
                </div>
            </div>
        </div>
