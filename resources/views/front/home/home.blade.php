                        ...
                        <div class="row">
                            <div class="col-md-7 col-lg-6 ">
                                <div class="detail-box">
                                    ...
                                    <p>
                                         Trying to be more unique and elevate your style? When you don't know where to begin, the task of revamping your entire wardrobe can appear daunting and often overwhelming. What is our recommendation? We provide Asian dress trends as well as the best Asian clothing. Asian fashion styles spreading into mainstream media around the world. Taking into consideration the vast styles offered in Asian fashion, Asian clothing to shop at (Name)
                                    </p>
                        ...
                        <div class="row">
                            <div class="col-md-7 col-lg-6 ">
                                <div class="detail-box">
                                    ...
                                    <p>
                                        What comes to mind when you think of traditional Asian clothes? It reminds us of excellence, rich embroidery and zardozi work, and extravagant silhouettes. This traditional look has evolved into a more contemporary style over time. (Name) creates exquisite fusions of traditional red bridal gowns and modern silhouettes. With intricate zardozi and stonework, layered tops, and flowy and voluminous skirts, our Asian wear captures the Mughal vibe. Long dromatic trails, 30 flowers, beaded tassels, scalloped edges, and flared sleeves add a modern touch.
                                    </p>
            ...
            <div class="col-sm-6 col-md-4 col-lg-4">
                <div class="box">
                    ...
                    <div class="detail-box">
                        ...
                        <h6>
                            ${{$service->crafting_price + ($service->crafting_price * .05)}}
                        </h6>
                    </div>
                </div>
            </div>
